...
## These models can all be conveniently invoked via the Sklearn library and are
## listed as follows:
...
## new columns the first-level predictions from our earlier classifiers and we 
## train the next classifier on this.
...
## predictions as x_train and x_test, we can now fit a second-level learning
## model.
